<div>
    ...
    <div class="mb-4 d-sm-flex align-items-center justify-content-between">
        ...
        <a href="#" class="shadow-sm d-none d-sm-inline-block btn btn-sm btn-primary"><i class="fas fa-download fa-sm text-white-50"></i> </a>
    </div>
        ...
        <div class="col-xl-12 col-lg-12">
            <div class="mb-4 shadow card">
                ...
                <div class="flex-row py-3 card-header d-flex align-items-center justify-content-between">
                    ...
                    <div>
                        <a href="{{ route('invoice.create', ['id' => $productsDashboard[0]->order_id]) }}" class="btn btn-success text-white m-2">Imprimer<i class="fa fa-print p-2" aria-hidden="true"></i></a>
                        <a type="button" wire:click.prevent="confirm({{ $productsDashboard[0]->order_id }})" class="btn btn-danger text-white">Confirmer<i class="fas fa-file-pdf p-2"></i></a>
    ...
    <div wire:ignore.self class="modal fade" id="product" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form method="post" action="">
                        ...
                        <div class="form-group">
                            <label for=""></label>
                            <input type="color" wire:model="color" class="form-control" name="" id="" aria-describedby="helpId" value="">
    ...
    {{-- modal search --}}
    <div wire:ignore.self class="modal fade" id="customer" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                        ...
                        <table class="table table-bordered" id="myTable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-success p1 text-white" wire:click="orderInit({{ $record->id }})">selectioner</button>
                                    </td>
                                </tr>
                                @endforeach
